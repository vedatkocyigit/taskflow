...
public class TaskE2ETest extends BaseE2ETest {

    @Test
    void shouldCreateTaskInTodo() {
        ...
        driver.findElement(By.cssSelector("[data-testid='register-email']"))
                .sendKeys("task+" + System.currentTimeMillis() + "@test.com");
        ...
        if (projectItem == null) {
            throw new RuntimeException("Project item not found");
        }
        ...
        assertTrue(driver.getPageSource().contains("My Task"));
    }
}
